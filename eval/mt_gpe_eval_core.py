...
def run_gpe_eval_core(
    ...
    **kwargs,
    ...
    if "oss" in metrics:
        ...
        oss_scores_flat = run_oss_eval(df_all, pe_flat, runs, oss_model, oss_model_path=oss_model_path)
    ...
    if "bleurt" in metrics:
        bleurt_scores_flat = run_bleurt_eval(df_all, pe_flat, runs, bleurt_model_path=bleurt_model_path)
