...
def build_translation_prompt(
    ...
    """Build an instruct MT prompt for the selected checkpoint protocol."""
    return _build_translation_prompt(
        source_lang, target_lang, source_text, prompt_version=prompt_version
    )
